...
#define TYPE_THEAD_TIMER     "csky_timer"
#define THEAD_TIMER(obj)     OBJECT_CHECK(csky_timer_state, (obj), \
                                         TYPE_THEAD_TIMER)
...
{
    csky_timer_state *s = (csky_timer_state *)opaque;
    ptimer_transaction_begin(s->timer[2]);
...
{
    csky_timer_state *s = (csky_timer_state *)opaque;
    ptimer_transaction_begin(s->timer[3]);
...
{
    csky_timer_state *s = THEAD_TIMER(obj);
